...
dfx canister create test_runner_http
...
TEST_RUNNER_NFT_ACCOUNT_2_ID=$(python3 principal_to_accountid.py $TEST_RUNNER_CANISTER_ID)

TEST_RUNNER_HTTP_CANISTER_ID=$(dfx canister id test_runner_http)
TEST_RUNNER_HTTP_ACCOUNT_ID=$(python3 principal_to_accountid.py $TEST_RUNNER_HTTP_CANISTER_ID)
DFX_EVENT_SYSTEM_ID="ll6wk-6iaaa-aaaaa-aacua-cai"
...
gzip ./.dfx/local/canisters/test_runner_http/test_runner_http.wasm -f
...
dfx canister install test_runner --mode=reinstall --wasm ./.dfx/local/canisters/test_runner/test_runner.wasm.gz --argument "(record{ canister_factory = principal \"$TEST_CANISTER_FACTORY_ID\"; storage_factory = principal \"$TEST_STORAGE_FACTORY_ID\"; dfx_ledger = opt (principal  \"$DFX_LEDGER_CANISTER_ID\"); dfx_ledger2 = opt (principal  \"$DFX_LEDGER_CANISTER2_ID\"); test_runner_nft = opt principal \"$TEST_RUNNER_NFT_CANISTER_ID\"; test_runner_nft_2 = opt principal \"$TEST_RUNNER_NFT_CANISTER_2_ID\"; test_runner_instant = opt(principal \"$TEST_RUNNER_INSTANT_CANISTER_ID\"); test_runner_data = opt(principal \"$TEST_RUNNER_DATA_CANISTER_ID\"); test_runner_utils = opt(principal \"$TEST_RUNNER_UTILS_CANISTER_ID\"); test_runner_collection = opt (principal \"$TEST_RUNNER_COLLECTION_CANISTER_ID\"); test_runner_storage= opt principal \"$TEST_RUNNER_STORAGE_CANISTER_ID\"; test_runner_sale = opt principal \"$TEST_RUNNER_SALE_CANISTER_ID\"; test_runner_http = opt principal \"$TEST_RUNNER_HTTP_CANISTER_ID\";})"
...
dfx canister install test_runner_http --mode=reinstall --wasm ./.dfx/local/canisters/test_runner_http/test_runner_http.wasm.gz --argument "(principal  \"$DFX_LEDGER_CANISTER_ID\", principal  \"$DFX_EVENT_SYSTEM_ID\")"
