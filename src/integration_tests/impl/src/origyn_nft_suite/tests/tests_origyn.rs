...
use crate::client::origyn_nft_reference::client::{
    get_nat_as_token_id_origyn, market_transfer_nft_origyn as market_transfer_nft_origyn_client,
    nft_origyn, sale_info_nft_origyn, sale_nft_origyn, update_metadata_node,
};
...
use origyn_nft_reference::origyn_nft_reference_canister::DepositDetail;
use origyn_nft_reference::origyn_nft_reference_canister::EscrowRequest;
use origyn_nft_reference::origyn_nft_reference_canister::{
    Account, Account3, AskFeature, BidRequest, CandyShared, EndingType, EscrowReceipt,
    EscrowRecord, FeeDepositRequest, IcTokenSpec, IcTokenSpecStandard, ManageSaleRequest,
    ManageSaleResult, PricingConfigShared, SaleInfoRequest, SaleInfoResponse, SaleInfoResult,
    SalesConfig, TokenSpec,
};
...
fn test_market_transfer_nft_origyn_timeout() {
    ...
    let ret: origyn_nft_reference::origyn_nft_reference_canister::MarketTransferResult =
        market_transfer_nft_origyn_client(
            pic,
            origyn_nft.clone(),
            nft_owner.clone(),
            ...
            market_transfer_nft_origynArgs {
                ...
                sales_config: SalesConfig {
                    ...
                    pricing: PricingConfigShared::Ask(Some(vec![
                        ...
                        AskFeature::Ending(EndingType::Timeout(Nat::from(
                            NANOS_PER_MILLISECOND * ((MINUTE_IN_MS * 100) as u64),
                        ))),
                    ])),
                    escrow_receipt: None,
                },
...
fn test_update_metadata_node() {
    ...
    let ret: crate::client::origyn_nft_reference::update_metadata_node::Response =
    ...
    let ret2: crate::client::origyn_nft_reference::update_metadata_node::Response =
        update_metadata_node(
            pic,
            origyn_nft.clone(),
            nft_owner.clone(),
...
fn test_market_transfer_nft_origyn_fee_account_bid_full_fee_account_fixed() {
    ...
    let res_fee_info = sale_info_nft_origyn(
        ...
        origyn_nft.clone(),
        nft_owner.clone(),
        SaleInfoRequest::FeeDepositInfo(Some(Account::Account {
    ...
    let fee_info = match res_fee_info {
        SaleInfoResult::Ok(sale_return) => match sale_return {
    ...
    let fee_balance_initial =
        icrc1_icrc2_token::client::balance_of(pic, ogy_ledger.clone(), fee_info);

    let approve_res: icrc1_icrc2_token::icrc2_approve::Response =
        icrc1_icrc2_token::client::approve(
            pic,
            nft_owner.clone(),
            ogy_ledger.clone(),
            origyn_nft.clone(),
    ...
    println!("approve_res: {:?}", approve_res);
    ...
    println!("fee deposit_res: {:?}", deposit_res);
    ...
    println!("owner_ogy_balance_initial: {:?}", owner_ogy_balance_initial);
    ...
    println!("buyer_ogy_balance_initial: {:?}", buyer_ogy_balance_initial);
    ...
    println!("fee_balance_before: {:?}", fee_balance_before);
    ...
    let deposit_res = sale_nft_origyn(
        ...
        origyn_nft.clone(),
        nft_buyer.clone(),
        ManageSaleRequest::EscrowDeposit(EscrowRequest {
            token_id: "0".to_string(),
    ...
    println!("escrow deposit_res: {:?}", deposit_res);
    ...
    let fee_balance_after =
        icrc1_icrc2_token::client::balance_of(pic, ogy_ledger.clone(), fee_info);
    println!("fee_balance_after: {:?}", fee_balance_after);
    ...
    println!("buyer_ogy_balance_after: {:?}", buyer_ogy_balance_after);
    ...
    println!("owner_ogy_balance_after: {:?}", owner_ogy_balance_after);
    ...
    // TODO: check the twice transfer fee
    assert_eq!(
        buyer_ogy_balance_after,
        buyer_ogy_balance_initial
            - Nat::from(100_000_000_000 as u64)
            - Nat::from(200_000 as u64)
            - Nat::from(200_000 as u64)
    );

    assert_eq!(
        owner_ogy_balance_after,
        owner_ogy_balance_initial + Nat::from(100_000_000_000 as u64)
...
fn test_market_transfer_nft_origyn_fee_account_bid_partial_fee_account_fixed() {
    ...
    let approve_res: icrc1_icrc2_token::icrc2_approve::Response =
        icrc1_icrc2_token::client::approve(
            ...
            origyn_nft.clone(),
            None,
            Nat::from(300_000_000_000 as u64) + Nat::from(200_000 as u32),
        );
...
fn test_market_transfer_nft_origyn_fee_account_bid_different_token_full_fee_account_fixed() {
    ...
    assert_eq!(
        ...
        owner_ldg_balance_initial + Nat::from(100_000_000_000 as u64)
            - Nat::from(2 as u32) * Nat::from(200_000 as u32)
    );
...
fn test_burned_tokens_list() {
    ...
    match transfer_fee {
        Some(fee) => {
            let balance =
                icrc1_icrc2_token::client::balance_of(pic, ogy_ledger.clone(), nft_owner.clone());
            ...
            let args: origyn_nft_reference::origyn_nft_reference_canister::TransferArgs =
                origyn_nft_reference::origyn_nft_reference_canister::TransferArgs {
                    memo: None,
            ...
            let response: origyn_nft_reference::origyn_nft_reference_canister::TransferResult =
                crate::client::origyn_nft_reference::client::icrc7_transfer(
                    pic,
                    origyn_nft.clone(),
                    nft_owner.clone(),
                    vec![args],
