...
shared (deployer) actor class Nft_Canister() = this {
    ...
    public shared (msg) func collection_update_nft_origyn(request : Types.ManageCollectionCommand) : async Result.Result<Bool, Types.OrigynError> {
        ...
        let log_data : Text = switch (request) {
            ...
            case (#UpdateAnnounceCanister(val)) {
                "Type : UpdateAnnounceCanister";
            };
        };
    ...
    public shared (msg) func manage_storage_nft_origyn(request : Types.ManageStorageRequest) : async Result.Result<Types.ManageStorageResponse, Types.OrigynError> {
        ...
        switch (request) {
            case (#configure_storage(val)) {
                ...
                } else return #err(Types.errors(?state.canistergeekLogger, #storage_configuration_error, "manage_storage_nft_origyn - allocation can't be empty " # debug_show (state.state.collection_data.allocated_storage), ?msg.caller));
    ...
    public shared (msg) func http_access_key() : async Result.Result<Text, Types.OrigynError> {
        ...
        debug if (debug_channel.function_announce) D.print("in http_access_key"); // nyi: spam prevention
...
*/
    ...
    public func insert_btree(tokenId : Text, libraryId : Text, i : Nat, chunk : Nat, value : Blob) : async () {
        ...
        let result = NFTUtils.getMemoryBySize(value.size(), btreemap_).insert(key, value);
