...
module {
    ...
    */
    ...
    /**
      ...
      */
    private func _build_storage_address(state : Types.State, use_token_id : Text, allocation_canister: Principal, path :Text ) : Text {
      switch(
      ...
      Metadata.get_primary_protocol(state, use_token_id, Principal.fromBlob("\04"))){
        ...
        case(_,_,_){
            "https://" # Principal.toText(allocation_canister) # ".raw.icp0.io/" # path
        };
      };
    ...
    */
    private func _redirect_to_storage_canister(
      ...
      debug if(debug_channel.library)  D.print("item is not on this server redir to " # Principal.toText(allocation_canister));
            ...
            let address = _build_storage_address(state, use_token_id, allocation_canister, path);
