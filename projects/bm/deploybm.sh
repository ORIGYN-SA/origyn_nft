...
node ./projects/deploy.js --meta=./projects/bm/def_collection_loaded.json --token_id=""  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_0.json --token_id="bm-0"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_1.json --token_id="bm-1"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_2.json --token_id="bm-2"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_3.json --token_id="bm-3"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_4.json --token_id="bm-4"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_5.json --token_id="bm-5"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_6.json --token_id="bm-6"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_7.json --token_id="bm-7"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_8.json --token_id="bm-8"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_9.json --token_id="bm-9"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_10.json --token_id="bm-10"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_11.json --token_id="bm-11"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_12.json --token_id="bm-12"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_13.json --token_id="bm-13"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_14.json --token_id="bm-14"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_15.json --token_id="bm-15"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_16.json --token_id="bm-16"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_17.json --token_id="bm-17"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=true --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_18.json --token_id="bm-18"  --mint_target=$TEST_WALLET --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
node ./projects/deploy.js --meta=./projects/bm/def_19.json --token_id="bm-19"  --mint_target=$ADMIN_PRINCIPAL --nft_canister=$NFT_CANISTER_ID --mint=false --prod=$env_prod --replica=$REPLICA_PORT
